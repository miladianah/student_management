          ...
          {classes.map((c) => (
            <div key={c.id} className="card hover:shadow-md transition-shadow">
              ...
              <div className="flex gap-2">
                ...
                <button
                  onClick={() => openEdit(c)}
                  className="px-3 py-2 rounded-lg border border-gray-200 hover:bg-amber-50 hover:border-amber-300 text-amber-600 transition-colors"
                  title="Edit"
                >
                  <Pencil size={15} />
                </button>
                <button
                  ...
                  className="px-3 py-2 rounded-lg border border-gray-200 hover:bg-red-50 hover:border-red-300 text-red-500 transition-colors"
                  title="Delete"
                >
                  <Trash2 size={15} />
                </button>
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md">
            <div className="flex items-center justify-between p-6 border-b">
              <h3 className="text-lg font-semibold">
                {editTarget ? 'Edit Class' : 'Create New Class'}
              </h3>
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm">
            <div className="p-6 text-center">
              ...
              <p className="text-red-500 text-xs mb-6">
                This will also remove all assignments, notes, results, and
            ...
            <div className="flex items-center justify-between p-6 border-b">
              <div>
                ...
                <p className="text-sm text-gray-500">
                  {studentsModal.class_name} {studentsModal.level}
                </p>
              </div>
